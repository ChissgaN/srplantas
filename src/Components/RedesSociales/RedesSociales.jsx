...
export const RedesSociales = () => {
 ...
 {visible && (
      ...
      <button
        className="fixed md:left-0 top-[349px] z-50 max-sm:right-0 sm:right-0 bg-slate-300 hover:bg-slate-400 w-4 hover:w-8  transition-all"  onClick={toggleVisibility}
      >
        <img
          src={arrow}
